...
namespace ANNS {
    ...
    class Storage : public IStorage {
        ...
        public:
            ...
            char* get_vector(IdxType idx) { return reinterpret_cast<char *>(vecs + (size_t)idx * dim); } //fxy_change
            ...
            inline void prefetch_vec_by_id(IdxType idx) const {
                ...
                for (size_t d = 0; d < prefetch_byte_num; d += 64) _mm_prefetch((const char *)(vecs + (size_t)idx * dim) + d, _MM_HINT_T0); //fxy_change
            }
