...
#pragma omp for
            ...
            for (size_t i = 0; i < k; i++) {
                FAISS_NAVIX_THROW_IF_NOT_FMT(
                        ...
                        size_t(heap_ids_2[i]),
                        heap_dis_2[i]);
                FAISS_NAVIX_THROW_IF_NOT(heap_dis[i] == heap_dis_2[i]);
            }

            for (size_t i = 0; i < k; i++) {
                FAISS_NAVIX_THROW_IF_NOT(heap_ids[i] == heap_ids_3[i]);
                FAISS_NAVIX_THROW_IF_NOT(heap_dis[i] == heap_dis_3[i]);
            }
        }
