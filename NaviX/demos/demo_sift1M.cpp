...
int main() {
...

    {
        ...
        printf("[%.3f s] Preparing index \"%s\" d=%ld\n",
               ...
               index_key,
               d);
        index = faiss_navix::index_factory(d, index_key);
    ...
    faiss_navix::idx_t* gt; // nq * k matrix of ground-truth nearest-neighbors
    ...
    { // run auto-tuning
        ...
        faiss_navix::OneRecallAtRCriterion crit(nq, 1);
        ...
        faiss_navix::ParameterSpace params;
        ...
        faiss_navix::OperatingPoints ops;
    ...
    { // Use the found configuration to perform a search
        ...
        // output buffers
        faiss_navix::idx_t* I = new faiss_navix::idx_t[nq * k];
