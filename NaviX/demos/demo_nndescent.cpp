...
int main(void) {
    ...
    faiss_navix::IndexNNDescentFlat index(d, K, faiss_navix::METRIC_L2);
    ...
    faiss_navix::IndexFlat bruteforce(d, faiss_navix::METRIC_L2);
    ...
    { // searching the database
        ...
        std::vector<faiss_navix::idx_t> gt_nns(k * nq);
