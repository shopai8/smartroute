...
int main() {
    ...
    */
    ...
    faiss_navix::gpu::StandardGpuResources resources;
    ...
    faiss_navix::gpu::GpuIndexIVFPQ index(
            &resources, d, ncentroids, 4, 8, faiss_navix::METRIC_L2, config);
    ...
    { // I/O demo
        ...
        faiss_navix::Index* cpu_index = faiss_navix::gpu::index_gpu_to_cpu(&index);
