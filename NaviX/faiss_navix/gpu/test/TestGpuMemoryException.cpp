...
TEST(TestGpuMemoryException, AddException) {
    ...
    faiss_navix::gpu::GpuIndexFlatL2 gpuIndexL2Broken(
            &res, (int)brokenAddDims, config);
    faiss_navix::gpu::GpuIndexFlatL2 gpuIndexL2(&res, (int)realAddDims, config);
    faiss_navix::IndexFlatL2 cpuIndex((int)realAddDims);
    ...
    {
        auto vecs = faiss_navix::gpu::randVecs(numRealAdd, realAddDims);
    ...
    {
        size_t numQuery = 10;
        auto vecs = faiss_navix::gpu::randVecs(numQuery, realAddDims);
