...
#include <faiss_navix/gpu/GpuIndexIVF.h>
#include <memory>
...
/// faiss_navix::IndexIVFScalarQuantizer
class GpuIndexIVFScalarQuantizer : public GpuIndexIVF {
   public:
    /// Construct from a pre-existing faiss_navix::IndexIVFScalarQuantizer instance,
    /// copying data over to the given GPU, if the input index is trained.
    GpuIndexIVFScalarQuantizer(
            GpuResourcesProvider* provider,
            const faiss_navix::IndexIVFScalarQuantizer* index,
    ...
    GpuIndexIVFScalarQuantizer(
            ...
            int dims,
            idx_t nlist,
            faiss_navix::ScalarQuantizer::QuantizerType qtype,
            faiss_navix::MetricType metric = MetricType::METRIC_L2,
    ...
    void copyFrom(const faiss_navix::IndexIVFScalarQuantizer* index);

    /// Copy ourselves to the given CPU index; will overwrite all data
    /// in the index instance
    void copyTo(faiss_navix::IndexIVFScalarQuantizer* index) const;
   ...
   public:
    ...
    faiss_navix::ScalarQuantizer sq;
