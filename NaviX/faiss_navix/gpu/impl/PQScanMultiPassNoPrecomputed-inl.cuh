...
#include <faiss_navix/gpu/GpuResources.h>
#include <faiss_navix/gpu/utils/DeviceUtils.h>
#include <faiss_navix/gpu/utils/StaticUtils.h>
#include <faiss_navix/gpu/impl/IVFUtils.cuh>
#include <faiss_navix/gpu/impl/PQCodeDistances.cuh>
#include <faiss_navix/gpu/impl/PQCodeLoad.cuh>
...
#include <faiss_navix/gpu/utils/LoadStoreOperators.cuh>
#include <faiss_navix/gpu/utils/NoTypeTensor.cuh>
#include <faiss_navix/gpu/utils/WarpPackedBits.cuh>
...
#define RUN_INTERLEAVED(BITS_PER_CODE, CODE_DIST_T)            \
    do {                                                       \
        ...
        FAISS_NAVIX_ASSERT(smem <= getMaxSharedMemPerBlockCurrentDevice());
