...
#include <faiss_navix/gpu/impl/GeneralDistance.cuh>
...
void allPairwiseDistanceOnDevice(
    ...
    if ((metric == faiss_navix::MetricType::METRIC_L2) ||
        (metric == faiss_navix::MetricType::METRIC_Lp && metricArg == 2)) {
        runAllPairwiseL2Distance(
                ...
                queriesRowMajor,
                outDistances);
    } else if (metric == faiss_navix::MetricType::METRIC_INNER_PRODUCT) {
        ...
        if ((metric == faiss_navix::MetricType::METRIC_L1) ||
            (metric == faiss_navix::MetricType::METRIC_Lp && metricArg == 1)) {
            runGeneralDistanceKernel(
                    ...
                    L1Distance(),
                    stream);
        } else if (metric == faiss_navix::MetricType::METRIC_Lp && metricArg == -1) {
            ...
            runGeneralDistanceKernel(
                    ...
                    L2Distance(),
                    stream);
        } else if (metric == faiss_navix::MetricType::METRIC_Lp) {
            runGeneralDistanceKernel(
                    tVectorsDimInnermost,
                    tQueriesDimInnermost,
                    outDistances,
                    ...
                    stream);
        } else if (metric == faiss_navix::MetricType::METRIC_Linf) {
            runGeneralDistanceKernel(
                    tVectorsDimInnermost,
                    tQueriesDimInnermost,
                    outDistances,
                    LinfDistance(),
                    stream);
        } else if (metric == faiss_navix::MetricType::METRIC_Canberra) {
            runGeneralDistanceKernel(
                    tVectorsDimInnermost,
                    tQueriesDimInnermost,
                    outDistances,
                    CanberraDistance(),
                    stream);
        } else if (metric == faiss_navix::MetricType::METRIC_BrayCurtis) {
            runGeneralDistanceKernel(
                    tVectorsDimInnermost,
                    tQueriesDimInnermost,
                    outDistances,
                    BrayCurtisDistance(),
                    stream);
        } else if (metric == faiss_navix::MetricType::METRIC_JensenShannon) {
            runGeneralDistanceKernel(
                    tVectorsDimInnermost,
                    tQueriesDimInnermost,
                    outDistances,
                    ...
                    stream);
        } else if (metric == faiss_navix::MetricType::METRIC_Jaccard) {
            runGeneralDistanceKernel(
                    tVectorsDimInnermost,
                    tQueriesDimInnermost,
                    outDistances,
            ...
            FAISS_NAVIX_THROW_FMT("unimplemented metric type %d", metric);
        }
    }
}
