...
class CuvsCagra {
   public:
    CuvsCagra(
            ...
            idx_t graph_degree,
            faiss_navix::cagra_build_algo graph_build_algo,
    ...
    void search(
            ...
            faiss_navix::cagra_search_algo graph_search_algo,
            idx_t team_size,
            idx_t search_width,
            idx_t min_iterations,
            idx_t thread_block_size,
            faiss_navix::cagra_hash_mode hash_mode,
   ...
   private:
    ...
    faiss_navix::MetricType metric_;

    /// Metric arg
    float metricArg_;

    /// Parameters to build cuVS CAGRA index
    faiss_navix::cagra_build_algo graph_build_algo_;
