...
/// faiss_navix::IndexIVFFlat
class GpuIndexIVFFlat : public GpuIndexIVF {
   public:
    /// Construct from a pre-existing faiss_navix::IndexIVFFlat instance, copying
    /// data over to the given GPU, if the input index is trained.
    GpuIndexIVFFlat(
            GpuResourcesProvider* provider,
            const faiss_navix::IndexIVFFlat* index,
    ...
    GpuIndexIVFFlat(
            ...
            int dims,
            idx_t nlist,
            faiss_navix::MetricType metric = faiss_navix::METRIC_L2,
            GpuIndexIVFFlatConfig config = GpuIndexIVFFlatConfig());
    ...
    void copyFrom(const faiss_navix::IndexIVFFlat* index);

    /// Copy ourselves to the given CPU index; will overwrite all data
    /// in the index instance
    void copyTo(faiss_navix::IndexIVFFlat* index) const;
   ...
   protected:
    ...
    void setIndex_(
            ...
            faiss_navix::ScalarQuantizer* scalarQ,
