...
class GpuIndex : public faiss_navix::Index {
   public:
    GpuIndex(
   ...
   protected:
    ...
    void copyFrom(const faiss_navix::Index* index);

    /// Copy what we have to the CPU equivalent
    void copyTo(faiss_navix::Index* index) const;
...
GpuIndex* tryCastGpuIndex(faiss_navix::Index* index);

/// Is the given index instance a GPU index?
bool isGpuIndex(faiss_navix::Index* index);

/// Does the given CPU index instance have a corresponding GPU implementation?
bool isGpuIndexImplemented(faiss_navix::Index* index);
