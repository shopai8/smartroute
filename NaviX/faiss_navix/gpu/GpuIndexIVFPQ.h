...
class GpuIndexIVFPQ : public GpuIndexIVF {
   public:
    /// Construct from a pre-existing faiss_navix::IndexIVFPQ instance, copying
    /// data over to the given GPU, if the input index is trained.
    GpuIndexIVFPQ(
            GpuResourcesProvider* provider,
            const faiss_navix::IndexIVFPQ* index,
    ...
    void copyFrom(const faiss_navix::IndexIVFPQ* index);

    /// Copy ourselves to the given CPU index; will overwrite all data
    /// in the index instance
    void copyTo(faiss_navix::IndexIVFPQ* index) const;
