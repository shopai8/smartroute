...
struct IndexMinMaxFP16Decoder {
    ...
    static void store(
        ...
        const float scaler = faiss_navix::decode_fp16(codeFP16[0]);
        const float minv = faiss_navix::decode_fp16(codeFP16[1]);
    ...
    static void accum(
        ...
        const uint16_t* const __restrict codeFP16 =
                reinterpret_cast<const uint16_t*>(code);
        const float scaler = faiss_navix::decode_fp16(codeFP16[0]) * weight;
        const float minv = faiss_navix::decode_fp16(codeFP16[1]) * weight;
    ...
    static void accum(
        ...
        const float scaler0 = faiss_navix::decode_fp16(code0FP16[0]) * weight0;
        const float minv0 = faiss_navix::decode_fp16(code0FP16[1]) * weight0;

        const uint16_t* const __restrict code1FP16 =
                reinterpret_cast<const uint16_t*>(code1);
        const float scaler1 = faiss_navix::decode_fp16(code1FP16[0]) * weight1;
        const float minv1 = faiss_navix::decode_fp16(code1FP16[1]) * weight1;
    ...
    static void accum(
        ...
        const float scaler2 = faiss_navix::decode_fp16(code2FP16[0]) * weight2;
        const float minv2 = faiss_navix::decode_fp16(code2FP16[1]) * weight2;
