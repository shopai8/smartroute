...
#ifndef FAISS_NAVIX_INDEX_IVF_H
#define FAISS_NAVIX_INDEX_IVF_H
...
FAISS_NAVIX_API extern bool check_compatible_for_merge_expensive_check;
...
FAISS_NAVIX_API extern IndexIVFStats indexIVF_stats;
