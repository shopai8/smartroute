...
IndexRefine::IndexRefine(Index* base_index, Index* refine_index)
    ...
    if (refine_index != nullptr) {
        FAISS_NAVIX_THROW_IF_NOT(base_index->d == refine_index->d);
        ...
        FAISS_NAVIX_THROW_IF_NOT(base_index->ntotal == refine_index->ntotal);
...
void IndexRefine::search(
    ...
    FAISS_NAVIX_THROW_IF_NOT(k_base >= k);

    FAISS_NAVIX_THROW_IF_NOT(base_index);
    FAISS_NAVIX_THROW_IF_NOT(refine_index);
