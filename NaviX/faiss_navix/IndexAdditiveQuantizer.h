...
#ifndef FAISS_NAVIX_INDEX_ADDITIVE_QUANTIZER_H
#define FAISS_NAVIX_INDEX_ADDITIVE_QUANTIZER_H
...
#include <faiss_navix/IndexFlatCodes.h>
#include <faiss_navix/impl/LocalSearchQuantizer.h>
#include <faiss_navix/impl/ProductAdditiveQuantizer.h>
