...
#ifndef FAISS_NAVIX_INDEX_H
#define FAISS_NAVIX_INDEX_H
...
#define FAISS_NAVIX_VERSION_MAJOR 1
#define FAISS_NAVIX_VERSION_MINOR 10
#define FAISS_NAVIX_VERSION_PATCH 0

// Macro to combine the version components into a single string
#ifndef FAISS_NAVIX_STRINGIFY
#define FAISS_NAVIX_STRINGIFY(ARG) #ARG
#endif
#ifndef FAISS_NAVIX_TOSTRING
#define FAISS_NAVIX_TOSTRING(ARG) FAISS_NAVIX_STRINGIFY(ARG)
#endif
#define VERSION_STRING                                          \
    FAISS_NAVIX_TOSTRING(FAISS_NAVIX_VERSION_MAJOR)                         \
    "." FAISS_NAVIX_TOSTRING(FAISS_NAVIX_VERSION_MINOR) "." FAISS_NAVIX_TOSTRING( \
            FAISS_NAVIX_VERSION_PATCH)
