...
#ifndef FAISS_NAVIX_INDEX_PQ_H
#define FAISS_NAVIX_INDEX_PQ_H
...
#include <faiss_navix/impl/PolysemousTraining.h>
...
FAISS_NAVIX_API extern IndexPQStats indexPQ_stats;
...
FAISS_NAVIX_API extern int multi_index_quantizer_search_bs;
