...
#ifndef FAISS_NAVIX_INDEX_IVFPQ_H
#define FAISS_NAVIX_INDEX_IVFPQ_H
...
FAISS_NAVIX_API extern size_t precomputed_table_max_bytes;
...
FAISS_NAVIX_API extern int index_ivfpq_add_core_o_bs;
...
FAISS_NAVIX_API extern IndexIVFPQStats indexIVFPQ_stats;
