...
void Index::add_with_ids(
        ...
        const float* /*x*/,
        const idx_t* /*xids*/) {
    FAISS_NAVIX_THROW_MSG("add_with_ids not implemented for this type of index");
}

size_t Index::remove_ids(const IDSelector& /*sel*/) {
    FAISS_NAVIX_THROW_MSG("remove_ids not implemented for this type of index");
    return -1;
}
...
void Index::add_sa_codes(idx_t, const uint8_t*, const idx_t*) {
    FAISS_NAVIX_THROW_MSG("add_sa_codes not implemented for this type of index");
}
