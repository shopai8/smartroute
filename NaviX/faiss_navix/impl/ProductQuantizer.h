...
#ifndef FAISS_NAVIX_PRODUCT_QUANTIZER_H
#define FAISS_NAVIX_PRODUCT_QUANTIZER_H
...
#include <faiss_navix/impl/Quantizer.h>
...
FAISS_NAVIX_API extern int product_quantizer_compute_codes_bs;
...
#include <faiss_navix/impl/ProductQuantizer-inl.h>
