...
#ifdef FAISS_NAVIX_MAIN_LIB
#define FAISS_NAVIX_API __declspec(dllexport)
#else // _FAISS_NAVIX_MAIN_LIB
#define FAISS_NAVIX_API __declspec(dllimport)
#endif // FAISS_NAVIX_MAIN_LIB
...
#define FAISS_NAVIX_ALWAYS_INLINE __forceinline
...
#define FAISS_NAVIX_ALWAYS_INLINE __attribute__((always_inline)) inline

#endif

#if defined(__GNUC__) || defined(__clang__)
#define FAISS_NAVIX_DEPRECATED(msg) __attribute__((deprecated(msg)))
#else
#define FAISS_NAVIX_DEPRECATED(msg)
#endif // GCC or Clang

// Localized enablement of imprecise floating point operations
// You need to use all 3 macros to cover all compilers.
#if defined(_MSC_VER)
#define FAISS_NAVIX_PRAGMA_IMPRECISE_LOOP
#define FAISS_NAVIX_PRAGMA_IMPRECISE_FUNCTION_BEGIN \
    __pragma(float_control(precise, off, push))
#define FAISS_NAVIX_PRAGMA_IMPRECISE_FUNCTION_END __pragma(float_control(pop))
...
#define FAISS_NAVIX_PRAGMA_IMPRECISE_FUNCTION_END _Pragma("float_control(pop)")
#else
#define FAISS_NAVIX_PRAGMA_IMPRECISE_LOOP \
...
#else
#define FAISS_NAVIX_PRAGMA_IMPRECISE_FUNCTION_BEGIN
#define FAISS_NAVIX_PRAGMA_IMPRECISE_FUNCTION_END
#endif
#endif
