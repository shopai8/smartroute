...
void beam_search_encode_step(
    ...
    FAISS_NAVIX_THROW_IF_NOT(new_beam_size <= beam_size * K);
    ...
    if (assign_index) {
        ...
        FAISS_NAVIX_THROW_IF_NOT(assign_index->d == d);
        ...
        if (assign_index->ntotal != 0) {
            ...
            FAISS_NAVIX_THROW_IF_NOT(assign_index->ntotal == K);
        } else {
...
void beam_search_encode_step_tab(
        ...
        ApproxTopK_mode_t approx_topk_mode) //
{
    FAISS_NAVIX_THROW_IF_NOT(ldc >= K);
