...
#include <faiss_navix/utils/partitioning.h>

#include <cassert>
#include <cmath>

#include <faiss_navix/impl/FaissAssert.h>
#include <faiss_navix/utils/AlignedTable.h>
#include <faiss_navix/utils/ordered_key_value.h>
...
typename C::T sample_threshold_median3(
    ...
    if (vi == 3) {
        ...
        return thresh_inf;
        //   FAISS_NAVIX_THROW_MSG("too few values to compute a median");
    }
}
...
#define DISPATCH(s)                                                     \
    ...
    switch (shift) {
        ...
        DISPATCH(13);
        default:
            FAISS_NAVIX_THROW_FMT("dispatch for shift=%d not instantiated", shift);
    }
#undef DISPATCH
