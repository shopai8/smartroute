...
#ifndef FAISS_NAVIX_hamming_inl_h
#define FAISS_NAVIX_hamming_inl_h

#include <faiss_navix/utils/hamming_distance/common.h>

#ifdef __aarch64__
// ARM compilers may produce inoptimal code for Hamming distance somewhy.
#include <faiss_navix/utils/hamming_distance/neon-inl.h>
#elif __AVX512F__
// offers better performance where __AVX512VPOPCNTDQ__ is supported
#include <faiss_navix/utils/hamming_distance/avx512-inl.h>
#elif __AVX2__
// better versions for GenHammingComputer
#include <faiss_navix/utils/hamming_distance/avx2-inl.h>
#else
#include <faiss_navix/utils/hamming_distance/generic-inl.h>
#endif
