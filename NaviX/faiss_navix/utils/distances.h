...
FAISS_NAVIX_API extern int distance_compute_blas_threshold;

// block sizes for BLAS distance computations
FAISS_NAVIX_API extern int distance_compute_blas_query_bs;
FAISS_NAVIX_API extern int distance_compute_blas_database_bs;

// above this number of results we switch to a reservoir to collect results
// rather than a heap
FAISS_NAVIX_API extern int distance_compute_min_k_reservoir;
