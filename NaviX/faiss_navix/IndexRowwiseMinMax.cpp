...
void IndexRowwiseMinMaxBase::add(idx_t, const float*) {
    FAISS_NAVIX_THROW_MSG("add not implemented for this type of index");
}
...
void IndexRowwiseMinMaxBase::search(
    ...
    FAISS_NAVIX_THROW_MSG("search not implemented for this type of index");
}

void IndexRowwiseMinMaxBase::reset() {
    FAISS_NAVIX_THROW_MSG("reset not implemented for this type of index");
}
