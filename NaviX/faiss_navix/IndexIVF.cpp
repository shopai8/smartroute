...
idx_t Level1Quantizer::decode_listno(const uint8_t* code) const {
    ...
    FAISS_NAVIX_THROW_IF_NOT(list_no >= 0 && list_no < nlist);
    return list_no;
}
...
InvertedListScanner* IndexIVF::get_InvertedListScanner(
    ...
    FAISS_NAVIX_THROW_MSG("get_InvertedListScanner not implemented");
}
...
void IndexIVF::update_vectors(int n, const idx_t* new_ids, const float* x) {
    ...
    FAISS_NAVIX_THROW_IF_NOT(direct_map.type == DirectMap::Array);
