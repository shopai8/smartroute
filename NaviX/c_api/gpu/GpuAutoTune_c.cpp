...
using faiss_navix::gpu::GpuClonerOptions;
using faiss_navix::gpu::GpuMultipleClonerOptions;
using faiss_navix::gpu::GpuResourcesProvider;

int faiss_index_gpu_to_cpu(const FaissIndex* gpu_index, FaissIndex** p_out) {
    try {
        auto cpu_index = faiss_navix::gpu::index_gpu_to_cpu(
...
int faiss_index_cpu_to_gpu(
    ...
    try {
        ...
        auto gpu_index = faiss_navix::gpu::index_cpu_to_gpu(
...
int faiss_index_cpu_to_gpu_multiple(
    ...
    try {
        ...
        auto gpu_index = faiss_navix::gpu::index_cpu_to_gpu_multiple(
