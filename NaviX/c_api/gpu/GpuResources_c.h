...
#ifndef FAISS_NAVIX_GPU_RESOURCES_C_H
#define FAISS_NAVIX_GPU_RESOURCES_C_H
...
FAISS_NAVIX_DECLARE_CLASS(GpuResources)

FAISS_NAVIX_DECLARE_DESTRUCTOR(GpuResources)
...
FAISS_NAVIX_DECLARE_CLASS(GpuResourcesProvider)

FAISS_NAVIX_DECLARE_DESTRUCTOR(GpuResourcesProvider)
