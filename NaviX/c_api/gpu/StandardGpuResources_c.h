...
#ifndef FAISS_NAVIX_STANDARD_GPURESOURCES_C_H
#define FAISS_NAVIX_STANDARD_GPURESOURCES_C_H
...
FAISS_NAVIX_DECLARE_CLASS_INHERITED(StandardGpuResources, GpuResourcesProvider)

FAISS_NAVIX_DECLARE_DESTRUCTOR(StandardGpuResources)
