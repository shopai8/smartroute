 ...
 */
FAISS_NAVIX_DECLARE_CLASS_INHERITED(IndexShards, Index)
FAISS_NAVIX_DECLARE_DESTRUCTOR(IndexShards)

FAISS_NAVIX_DECLARE_GETTER_SETTER(IndexShards, int, own_fields)
FAISS_NAVIX_DECLARE_GETTER_SETTER(IndexShards, int, successive_ids)
