...
#ifndef FAISS_NAVIX_INDEX_BINARY_C_H
#define FAISS_NAVIX_INDEX_BINARY_C_H
...
FAISS_NAVIX_DECLARE_CLASS(IndexBinary)
FAISS_NAVIX_DECLARE_DESTRUCTOR(IndexBinary)

/// Getter for d
FAISS_NAVIX_DECLARE_GETTER(IndexBinary, int, d)

/// Getter for is_trained
FAISS_NAVIX_DECLARE_GETTER(IndexBinary, int, is_trained)

/// Getter for ntotal
FAISS_NAVIX_DECLARE_GETTER(IndexBinary, idx_t, ntotal)

/// Getter for metric_type
FAISS_NAVIX_DECLARE_GETTER(IndexBinary, FaissMetricType, metric_type)

FAISS_NAVIX_DECLARE_GETTER_SETTER(IndexBinary, int, verbose)
