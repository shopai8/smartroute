...
#ifndef FAISS_NAVIX_CLUSTERING_C_H
#define FAISS_NAVIX_CLUSTERING_C_H
 ...
 */
FAISS_NAVIX_DECLARE_CLASS(Clustering)

FAISS_NAVIX_DECLARE_GETTER(Clustering, int, niter)
FAISS_NAVIX_DECLARE_GETTER(Clustering, int, nredo)
FAISS_NAVIX_DECLARE_GETTER(Clustering, int, verbose)
FAISS_NAVIX_DECLARE_GETTER(Clustering, int, spherical)
FAISS_NAVIX_DECLARE_GETTER(Clustering, int, int_centroids)
FAISS_NAVIX_DECLARE_GETTER(Clustering, int, update_index)
FAISS_NAVIX_DECLARE_GETTER(Clustering, int, frozen_centroids)

FAISS_NAVIX_DECLARE_GETTER(Clustering, int, min_points_per_centroid)
FAISS_NAVIX_DECLARE_GETTER(Clustering, int, max_points_per_centroid)

FAISS_NAVIX_DECLARE_GETTER(Clustering, int, seed)
FAISS_NAVIX_DECLARE_GETTER(Clustering, size_t, decode_block_size)

/// getter for d
FAISS_NAVIX_DECLARE_GETTER(Clustering, size_t, d)

/// getter for k
FAISS_NAVIX_DECLARE_GETTER(Clustering, size_t, k)

FAISS_NAVIX_DECLARE_CLASS(ClusteringIterationStats)
FAISS_NAVIX_DECLARE_GETTER(ClusteringIterationStats, float, obj)
FAISS_NAVIX_DECLARE_GETTER(ClusteringIterationStats, double, time)
FAISS_NAVIX_DECLARE_GETTER(ClusteringIterationStats, double, time_search)
FAISS_NAVIX_DECLARE_GETTER(ClusteringIterationStats, double, imbalance_factor)
FAISS_NAVIX_DECLARE_GETTER(ClusteringIterationStats, int, nsplit)
