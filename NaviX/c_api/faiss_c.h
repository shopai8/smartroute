...
#ifndef FAISS_NAVIX_C_H
#define FAISS_NAVIX_C_H
...
#define FAISS_NAVIX_DECLARE_CLASS(clazz) typedef struct Faiss##clazz##_H Faiss##clazz;

/// Declare an opaque type for a class type `clazz`, while
/// actually aliasing it to an existing parent class type `parent`.
#define FAISS_NAVIX_DECLARE_CLASS_INHERITED(clazz, parent) \
...
#define FAISS_NAVIX_DECLARE_INDEX_DOWNCAST(clazz) \
...
#define FAISS_NAVIX_DECLARE_SEARCH_PARAMETERS_DOWNCAST(clazz) \
    Faiss##clazz* faiss_##clazz##_cast(FaissSearchParameters*);

/// Declare a getter for the field `name` in class `clazz`,
/// of return type `ty`
#define FAISS_NAVIX_DECLARE_GETTER(clazz, ty, name) \
...
#define FAISS_NAVIX_DECLARE_SETTER(clazz, ty, name) \
    void faiss_##clazz##_set_##name(Faiss##clazz*, ty);

/// Declare a getter and setter for the field `name` in class `clazz`.
#define FAISS_NAVIX_DECLARE_GETTER_SETTER(clazz, ty, name) \
    FAISS_NAVIX_DECLARE_GETTER(clazz, ty, name)            \
    FAISS_NAVIX_DECLARE_SETTER(clazz, ty, name)

/// Declare a destructor function which frees an object of
/// type `clazz`.
#define FAISS_NAVIX_DECLARE_DESTRUCTOR(clazz) \
