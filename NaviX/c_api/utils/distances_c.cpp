...
void faiss_pairwise_L2sqr(
        ...
        int64_t ldb,
        int64_t ldd) {
    faiss_navix::pairwise_L2sqr(d, nq, xq, nb, xb, dis, ldq, ldb, ldd);
}
...
void faiss_pairwise_L2sqr_with_defaults(
        ...
        const float* xb,
        float* dis) {
    faiss_navix::pairwise_L2sqr(d, nq, xq, nb, xb, dis);
}
...
void faiss_fvec_inner_products_ny(
        ...
        size_t d,
        size_t ny) {
    faiss_navix::fvec_inner_products_ny(ip, x, y, d, ny);
}
