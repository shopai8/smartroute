...
#ifndef FAISS_NAVIX_AUX_INDEX_STRUCTURES_C_H
#define FAISS_NAVIX_AUX_INDEX_STRUCTURES_C_H
...
FAISS_NAVIX_DECLARE_CLASS(RangeSearchResult)

FAISS_NAVIX_DECLARE_GETTER(RangeSearchResult, size_t, nq)
...
FAISS_NAVIX_DECLARE_DESTRUCTOR(RangeSearchResult)

/// getter for buffer_size
FAISS_NAVIX_DECLARE_GETTER(RangeSearchResult, size_t, buffer_size)
...
FAISS_NAVIX_DECLARE_CLASS(IDSelector)
FAISS_NAVIX_DECLARE_DESTRUCTOR(IDSelector)

int faiss_IDSelector_is_member(const FaissIDSelector* sel, idx_t id);

/** remove ids between [imni, imax) */
FAISS_NAVIX_DECLARE_CLASS(IDSelectorRange)
FAISS_NAVIX_DECLARE_DESTRUCTOR(IDSelectorRange)

FAISS_NAVIX_DECLARE_GETTER(IDSelectorRange, idx_t, imin)
FAISS_NAVIX_DECLARE_GETTER(IDSelectorRange, idx_t, imax)
...
FAISS_NAVIX_DECLARE_CLASS(IDSelectorBatch)

FAISS_NAVIX_DECLARE_GETTER(IDSelectorBatch, int, nbits)
FAISS_NAVIX_DECLARE_GETTER(IDSelectorBatch, idx_t, mask)
...
FAISS_NAVIX_DECLARE_CLASS(IDSelectorBitmap)
FAISS_NAVIX_DECLARE_DESTRUCTOR(IDSelectorBitmap)

FAISS_NAVIX_DECLARE_GETTER(IDSelectorBitmap, size_t, n)
FAISS_NAVIX_DECLARE_GETTER(IDSelectorBitmap, const uint8_t*, bitmap)
...
FAISS_NAVIX_DECLARE_CLASS(BufferList)
FAISS_NAVIX_DECLARE_DESTRUCTOR(BufferList)

FAISS_NAVIX_DECLARE_GETTER(BufferList, size_t, buffer_size)
FAISS_NAVIX_DECLARE_GETTER(BufferList, size_t, wp)
...
FAISS_NAVIX_DECLARE_CLASS(RangeSearchPartialResult)

/// result structure for a single query
FAISS_NAVIX_DECLARE_CLASS(RangeQueryResult)
FAISS_NAVIX_DECLARE_GETTER(RangeQueryResult, idx_t, qno)
FAISS_NAVIX_DECLARE_GETTER(RangeQueryResult, size_t, nres)
FAISS_NAVIX_DECLARE_GETTER(RangeQueryResult, FaissRangeSearchPartialResult*, pres)

int faiss_RangeQueryResult_add(FaissRangeQueryResult* qr, float dis, idx_t id);

FAISS_NAVIX_DECLARE_GETTER(RangeSearchPartialResult, FaissRangeSearchResult*, res)
...
FAISS_NAVIX_DECLARE_CLASS(DistanceComputer)
...
FAISS_NAVIX_DECLARE_DESTRUCTOR(DistanceComputer)
