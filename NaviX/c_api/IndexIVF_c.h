...
#ifndef FAISS_NAVIX_INDEX_IVF_C_H
#define FAISS_NAVIX_INDEX_IVF_C_H
...
FAISS_NAVIX_DECLARE_CLASS_INHERITED(SearchParametersIVF, SearchParameters)
FAISS_NAVIX_DECLARE_DESTRUCTOR(SearchParametersIVF)
FAISS_NAVIX_DECLARE_SEARCH_PARAMETERS_DOWNCAST(SearchParametersIVF)
...
FAISS_NAVIX_DECLARE_GETTER(SearchParametersIVF, const FaissIDSelector*, sel)
FAISS_NAVIX_DECLARE_GETTER_SETTER(SearchParametersIVF, size_t, nprobe)
FAISS_NAVIX_DECLARE_GETTER_SETTER(SearchParametersIVF, size_t, max_codes)
 ...
 */
FAISS_NAVIX_DECLARE_CLASS_INHERITED(IndexIVF, Index)
FAISS_NAVIX_DECLARE_DESTRUCTOR(IndexIVF)
FAISS_NAVIX_DECLARE_INDEX_DOWNCAST(IndexIVF)

/// number of possible key values
FAISS_NAVIX_DECLARE_GETTER(IndexIVF, size_t, nlist)
/// number of probes at query time
FAISS_NAVIX_DECLARE_GETTER_SETTER(IndexIVF, size_t, nprobe)
/// quantizer that maps vectors to inverted lists
FAISS_NAVIX_DECLARE_GETTER(IndexIVF, FaissIndex*, quantizer)
/**
 * = 0: use the quantizer as index in a kmeans training
 * = 1: just pass on the training set to the train() of the quantizer
 * = 2: kmeans training on a flat index + add the centroids to the quantizer
 */
FAISS_NAVIX_DECLARE_GETTER(IndexIVF, char, quantizer_trains_alone)

/// whether object owns the quantizer
FAISS_NAVIX_DECLARE_GETTER_SETTER(IndexIVF, int, own_fields)
