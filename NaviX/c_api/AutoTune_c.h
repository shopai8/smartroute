...
#ifndef FAISS_NAVIX_AUTO_TUNE_C_H
#define FAISS_NAVIX_AUTO_TUNE_C_H
...
FAISS_NAVIX_DECLARE_CLASS(ParameterRange)

FAISS_NAVIX_DECLARE_GETTER(ParameterRange, const char*, name)
 ...
 */
FAISS_NAVIX_DECLARE_CLASS(ParameterSpace)

FAISS_NAVIX_DECLARE_DESTRUCTOR(ParameterSpace)
