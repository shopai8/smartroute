...
using faiss_navix::IndexIVFScalarQuantizer;
using faiss_navix::IndexScalarQuantizer;
...
int faiss_IndexScalarQuantizer_new_with(
    ...
    try {
        IndexScalarQuantizer* index = new IndexScalarQuantizer(
                d,
                static_cast<faiss_navix::ScalarQuantizer::QuantizerType>(qt),
                static_cast<faiss_navix::MetricType>(metric));
...
int faiss_IndexIVFScalarQuantizer_new_with(
    ...
    try {
        ...
        auto qt_ = static_cast<faiss_navix::ScalarQuantizer::QuantizerType>(qt);
...
int faiss_IndexIVFScalarQuantizer_new_with_metric(
    ...
    try {
        auto q = reinterpret_cast<Index*>(quantizer);
        auto mt = static_cast<faiss_navix::MetricType>(metric);
