 ...
 */
FAISS_NAVIX_DECLARE_CLASS_INHERITED(IndexReplicas, Index)
FAISS_NAVIX_DECLARE_DESTRUCTOR(IndexReplicas)

FAISS_NAVIX_DECLARE_GETTER_SETTER(IndexReplicas, int, own_fields)
