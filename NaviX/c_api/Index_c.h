...
#ifndef FAISS_NAVIX_INDEX_C_H
#define FAISS_NAVIX_INDEX_C_H
...
FAISS_NAVIX_DECLARE_CLASS(SearchParameters)
FAISS_NAVIX_DECLARE_DESTRUCTOR(SearchParameters)
...
FAISS_NAVIX_DECLARE_CLASS(Index)
FAISS_NAVIX_DECLARE_DESTRUCTOR(Index)

/// Getter for d
FAISS_NAVIX_DECLARE_GETTER(Index, int, d)

/// Getter for is_trained
FAISS_NAVIX_DECLARE_GETTER(Index, int, is_trained)

/// Getter for ntotal
FAISS_NAVIX_DECLARE_GETTER(Index, idx_t, ntotal)

/// Getter for metric_type
FAISS_NAVIX_DECLARE_GETTER(Index, FaissMetricType, metric_type)

FAISS_NAVIX_DECLARE_GETTER_SETTER(Index, int, verbose)
