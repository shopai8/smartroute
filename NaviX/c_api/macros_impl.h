...
#define CATCH_AND_HANDLE                                                      \
    catch (faiss_navix::FaissException & e) {                                       \
