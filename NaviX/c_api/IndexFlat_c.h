...
#ifndef FAISS_NAVIX_INDEX_FLAT_C_H
#define FAISS_NAVIX_INDEX_FLAT_C_H
...
FAISS_NAVIX_DECLARE_CLASS_INHERITED(IndexFlat, Index)
 ...
 */
FAISS_NAVIX_DECLARE_INDEX_DOWNCAST(IndexFlat)

FAISS_NAVIX_DECLARE_DESTRUCTOR(IndexFlat)
...
FAISS_NAVIX_DECLARE_CLASS_INHERITED(IndexFlatIP, Index)

FAISS_NAVIX_DECLARE_INDEX_DOWNCAST(IndexFlatIP)
FAISS_NAVIX_DECLARE_DESTRUCTOR(IndexFlatIP)
...
FAISS_NAVIX_DECLARE_CLASS_INHERITED(IndexFlatL2, Index)

FAISS_NAVIX_DECLARE_INDEX_DOWNCAST(IndexFlatL2)
FAISS_NAVIX_DECLARE_DESTRUCTOR(IndexFlatL2)
 ...
 */
FAISS_NAVIX_DECLARE_CLASS_INHERITED(IndexRefineFlat, Index)

int faiss_IndexRefineFlat_new(
        FaissIndexRefineFlat** p_index,
        FaissIndex* base_index);

FAISS_NAVIX_DECLARE_DESTRUCTOR(IndexRefineFlat)
FAISS_NAVIX_DECLARE_INDEX_DOWNCAST(IndexRefineFlat)

FAISS_NAVIX_DECLARE_GETTER_SETTER(IndexRefineFlat, int, own_fields)

/// factor between k requested in search and the k requested from
/// the base_index (should be >= 1)
FAISS_NAVIX_DECLARE_GETTER_SETTER(IndexRefineFlat, float, k_factor)

/** Opaque type for IndexFlat1D
 *
 * optimized version for 1D "vectors"
 */
FAISS_NAVIX_DECLARE_CLASS_INHERITED(IndexFlat1D, Index)

FAISS_NAVIX_DECLARE_INDEX_DOWNCAST(IndexFlat1D)
FAISS_NAVIX_DECLARE_DESTRUCTOR(IndexFlat1D)
