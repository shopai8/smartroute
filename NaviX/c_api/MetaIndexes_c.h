...
FAISS_NAVIX_DECLARE_CLASS_INHERITED(IndexIDMap, Index)

FAISS_NAVIX_DECLARE_GETTER_SETTER(IndexIDMap, int, own_fields)
 ...
 */
FAISS_NAVIX_DECLARE_INDEX_DOWNCAST(IndexIDMap)
...
FAISS_NAVIX_DECLARE_CLASS_INHERITED(IndexIDMap2, Index)

FAISS_NAVIX_DECLARE_GETTER_SETTER(IndexIDMap2, int, own_fields)
 ...
 */
FAISS_NAVIX_DECLARE_INDEX_DOWNCAST(IndexIDMap2)
