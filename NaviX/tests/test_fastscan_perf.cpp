...
TEST(TestFastScan, knnVSrange) {
    ...
    faiss_navix::IndexIVFPQFastScan index(
            &coarse_quantizer, d, nlist, d / 2, 4, faiss_navix::METRIC_L2, 32);
