...
#include <faiss_navix/IndexAdditiveQuantizer.h> // @manual=//faiss:faiss_no_multithreading
#include <faiss_navix/utils/random.h> // @manual=//faiss:faiss_no_multithreading
